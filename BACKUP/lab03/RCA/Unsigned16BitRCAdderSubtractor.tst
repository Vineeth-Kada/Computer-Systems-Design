load Unsigned16BitRCAdderSubtractor.hdl,
output-file Unsigned16BitRCAdderSubtractor.out,
compare-to Unsigned16BitRCAdderSubtractor.cmp,
...
// No need to check for overflow as not asked in question
